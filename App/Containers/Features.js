...
class Features extends React.Component {
  ...
  async componentWillMount() {
    ...
    .then(() => {
      ...
      fetch('http://capthis.technopathic.me/api/suggestFollows?token=' + this.state.token, {
        headers:{
  ...
  getFeature = () => {
    ...
    {
      fetch('http://capthis.technopathic.me/api/getFollowTopics?page='+this.state.nextPage+'&token=' + this.state.token, {
        headers:{
          'Authorization': 'Bearer ' + this.state.token
        }
      })
