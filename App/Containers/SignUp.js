...
import { View, StatusBar, ScrollView, Text, Image, Modal, AsyncStorage, Dimensions } from 'react-native'
...
class SignUp extends React.Component {
  ...
  signUp() {
    var _this = this;
    fetch('http://capthis.technopathic.me/api/signUp', {
      method: 'POST',
      body: JSON.stringify({
        email: this.state.email,
            ...
            <View style={backgroundContainer}>
              ...
              <View style={inputContainer}>
                ...
                <InputGroup>
                  ...
                  <Input placeholder='Username' style={inputStyle} value={this.state.name} onChange={this.handleName} placeholderTextColor="#AAAAAA" selectionColor="#ffbe39" underlineColorAndroid="#ffbe39"/>
                </InputGroup>

                <InputGroup>
                  <Icon name='md-lock' style={iconStyle}/>
                  <Input placeholder='Password' secureTextEntry={true} style={inputStyle} value={this.state.password} onChange={this.handlePassword} placeholderTextColor="#AAAAAA" selectionColor="#ffbe39" underlineColorAndroid="#ffbe39" onSubmitEditing={() => this.signUp()}/>
                </InputGroup>
