...
class Notifications extends React.Component {
 ...
 getNotifs = () => {
  fetch('http://capthis.technopathic.me/api/getNotifs?token=' + this.state.token, {
    headers:{
  ...
  fetch('http://capthis.technopathic.me/api/readNotifs?token=' + this.state.token, {
    headers:{
      'Authorization': 'Bearer ' + this.state.token
    }
  });
  ...
  deleteNotif(id, index, type)
  {
    ...
    fetch('http://capthis.technopathic.me/api/deleteNotif/'+id+'?token=' + this.state.token, {
      method: 'POST',
      headers:{
        'Authorization': 'Bearer ' + this.state.token
      }
  ...
  acceptRequest(id, peerID, index)
  {
    var _this = this;
    var requests = this.state.requests;
    fetch('http://capthis.technopathic.me/api/acceptRequest/'+id+'/'+peerID+'?token=' + this.state.token, {
      method: 'POST',
      headers:{
        'Authorization': 'Bearer ' + this.state.token
      }
  ...
  denyRequest(id, peerID, index)
  {
    var _this = this;
    var requests = this.state.requests;
    fetch('http://capthis.technopathic.me/api/denyRequest/'+id+'/'+peerID+'?token=' + this.state.token, {
      method: 'POST',
      headers:{
        'Authorization': 'Bearer ' + this.state.token
      }
